...
class FocusedCommentTester:
    def __init__(self, base_url="https://tools-resolver.preview.emergentagent.com/api"):
    ...
    def test_cors_and_headers(self):
        ...
        headers = {
            'Origin': 'https://tools-resolver.preview.emergentagent.com',
            'Referer': 'https://tools-resolver.preview.emergentagent.com/blogs'
        }
