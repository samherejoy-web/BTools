...
class FocusedCommentTester:
    def __init__(self, base_url="https://admin-tools-hub.preview.emergentagent.com/api"):
    ...
    def test_cors_and_headers(self):
        ...
        headers = {
            'Origin': 'https://admin-tools-hub.preview.emergentagent.com',
            'Referer': 'https://admin-tools-hub.preview.emergentagent.com/blogs'
        }
