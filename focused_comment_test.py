...
class FocusedCommentTester:
    def __init__(self, base_url="https://company-data-enhance.preview.emergentagent.com/api"):
    ...
    def test_cors_and_headers(self):
        ...
        headers = {
            'Origin': 'https://company-data-enhance.preview.emergentagent.com',
            'Referer': 'https://company-data-enhance.preview.emergentagent.com/blogs'
        }
