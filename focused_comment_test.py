...
class FocusedCommentTester:
    def __init__(self, base_url="https://seo-semantic-sync.preview.emergentagent.com/api"):
    ...
    def test_cors_and_headers(self):
        ...
        headers = {
            'Origin': 'https://seo-semantic-sync.preview.emergentagent.com',
            'Referer': 'https://seo-semantic-sync.preview.emergentagent.com/blogs'
        }
