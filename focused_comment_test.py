...
class FocusedCommentTester:
    def __init__(self, base_url="https://interact-sync.preview.emergentagent.com/api"):
    ...
    def test_cors_and_headers(self):
        ...
        headers = {
            'Origin': 'https://interact-sync.preview.emergentagent.com',
            'Referer': 'https://interact-sync.preview.emergentagent.com/blogs'
        }
