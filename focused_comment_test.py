...
class FocusedCommentTester:
    def __init__(self, base_url="https://clean-deploy-prep.preview.emergentagent.com/api"):
    ...
    def test_cors_and_headers(self):
        ...
        headers = {
            'Origin': 'https://clean-deploy-prep.preview.emergentagent.com',
            'Referer': 'https://clean-deploy-prep.preview.emergentagent.com/blogs'
        }
