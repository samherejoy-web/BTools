...
allowed_origins.extend([
    ...
    "https://site-content-mgmt.preview.emergentagent.com",
...
app.include_router(static_pages_router, prefix="", tags=["static-pages"])
app.include_router(site_settings_router, prefix="", tags=["site-settings"])
